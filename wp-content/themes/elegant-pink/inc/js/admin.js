jQuery(document).ready(function($){
	...
	$('#accordion-panel-wp_default_panel').prepend(
		...
		'<span class="sticky_info_row"><label class="row-element">Support forum: </label><a href="http://raratheme.com/support-forum/forum/elegant-pink/" target="_blnak">here</a></span>'+
		'<span class="sticky_info_row"><label class="row-element">Email us: </label><a href="mailto:support@raratheme.com">support@raratheme.com<a/></span>'+
