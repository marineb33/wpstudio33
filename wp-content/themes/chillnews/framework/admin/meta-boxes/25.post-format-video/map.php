...
$video_post_format_meta_box = chillnews_mikado_add_meta_box(
	array(
		'scope' =>	array('post'),
...
$mkdf_video_embedded_container = chillnews_mikado_add_admin_container(
	array(
		'parent' => $video_post_format_meta_box,
...
$mkdf_video_self_hosted_container = chillnews_mikado_add_admin_container(
	array(
		'parent' => $video_post_format_meta_box,
