...
if ( ! function_exists('chillnews_mikado_content_options_map') ) {

    function chillnews_mikado_content_options_map() {
        ...
        $panel_content = chillnews_mikado_add_admin_panel(
            array(
                'page'  => '_content_page',
                'name'  => 'panel_content',
                'title' => 'General'
    ...
    add_action( 'chillnews_mikado_options_map', 'chillnews_mikado_content_options_map', 10 );
