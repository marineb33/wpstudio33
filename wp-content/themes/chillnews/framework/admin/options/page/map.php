...
if ( ! function_exists('chillnews_mikado_page_options_map') ) {

    function chillnews_mikado_page_options_map() {
        ...
        $panel_sidebar = chillnews_mikado_add_admin_panel(
            array(
                'page'  => '_page_page',
                'name'  => 'panel_sidebar',
                'title' => 'Design Style'
        ...
        $panel_widgets = chillnews_mikado_add_admin_panel(
            array(
                'page'  => '_page_page',
                'name'  => 'panel_widgets',
                'title' => 'Widgets'
        ...
        $group_sidebar_padding = chillnews_mikado_add_admin_group(array(
            'name'      => 'group_sidebar_padding',
            'title'     => 'Padding',
            'parent'    => $panel_widgets
        ));

        $row_sidebar_padding = chillnews_mikado_add_admin_row(array(
    ...
    add_action( 'chillnews_mikado_options_map', 'chillnews_mikado_page_options_map', 10);
}