...
if ( ! function_exists('chillnews_mikado_social_options_map') ) {

	function chillnews_mikado_social_options_map() {

		chillnews_mikado_add_admin_page(
			array(
				'slug'  => '_social_page',
				'title' => 'Social Netwrork',
		 ...
		 * Enable Social Share
		 */
		$panel_social_share = chillnews_mikado_add_admin_panel(array(
			'page'  => '_social_page',
		...
		$panel_show_social_share_on = chillnews_mikado_add_admin_panel(array(
			'page'  			=> '_social_page',
		 ...
		 */
		$panel_social_networks = chillnews_mikado_add_admin_panel(array(
			'page'  			=> '_social_page',
		...
		$enable_facebook_share_container = chillnews_mikado_add_admin_container(array(
		...
		$enable_twitter_share_container = chillnews_mikado_add_admin_container(array(
		...
		$enable_google_plus_container = chillnews_mikado_add_admin_container(array(
		...
		$enable_linkedin_container = chillnews_mikado_add_admin_container(array(
		...
		$enable_tumblr_container = chillnews_mikado_add_admin_container(array(
		...
		$enable_pinterest_container = chillnews_mikado_add_admin_container(array(
		...
		$enable_vk_container = chillnews_mikado_add_admin_container(array(
		...
		if(defined('MIKADOF_TWITTER_FEED_VERSION')) {
            $twitter_panel = chillnews_mikado_add_admin_panel(array(
                'title' => 'Twitter',
                'name'  => 'panel_twitter',
                'page'  => '_social_page'
            ));

            chillnews_mikado_add_admin_twitter_button(array(
                'name'   => 'twitter_button',
        ...
        if(defined('MIKADOF_INSTAGRAM_FEED_VERSION')) {
            $instagram_panel = chillnews_mikado_add_admin_panel(array(
                'title' => 'Instagram',
                'name'  => 'panel_instagram',
                'page'  => '_social_page'
            ));

            chillnews_mikado_add_admin_instagram_button(array(
	...
	add_action( 'chillnews_mikado_options_map', 'chillnews_mikado_social_options_map', 14);
