...
/*
  Class: ChillNewsIconCollections
...
class ChillNewsIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new ChillNewsIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new ChillNewsIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new ChillNewsIonIcons("Ion Icons", "ion_icon"));
    }
    ...
    public function getIconCollectionIcons(iChillNewsInterfaceIconCollection $collection) {
...
$chillnews_mikado_global_IconCollections = ChillNewsIconCollections::get_instance();