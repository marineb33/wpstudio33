...
<?php do_action('chillnews_mikado_before_header_top'); ?>

<div class="mkdf-top-bar">
    <?php if($top_bar_in_grid) : ?>
    <div class="mkdf-grid">
    <?php endif; ?>
		<?php do_action( 'chillnews_mikado_after_header_top_html_open' ); ?>
...
<?php do_action('chillnews_mikado_after_header_top'); ?>
