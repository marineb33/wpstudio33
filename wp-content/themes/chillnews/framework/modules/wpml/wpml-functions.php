...
if(!function_exists('chillnews_mikado_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function chillnews_mikado_get_wpml_pages_for_current_page() {
		$wpml_pages_for_current_page = array();

		if(chillnews_mikado_is_wpml_installed()) {
...
if(!function_exists('chillnews_mikado_disable_wpml_css')) {
    function chillnews_mikado_disable_wpml_css() {
	    define('ICL_DONT_LOAD_LANGUAGE_SELECTOR_CSS', true);
    }

	add_action('after_setup_theme', 'chillnews_mikado_disable_wpml_css');
}