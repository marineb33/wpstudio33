...
if(chillnews_mikado_options()->getOptionValue('blog_list_feature_image_max_width') !== ''){
	$display_custom_feature_image_width = intval(chillnews_mikado_options()->getOptionValue('blog_list_feature_image_max_width'));
}
?>
					...
					foreach($image_gallery_array as $gimg_id): ?>
						<li class="mkdf-pg-slides"><a itemprop="url" href="<?php the_permalink(); ?>">
							<?php if($display_custom_feature_image_width !== '') {
								...
								echo wp_get_attachment_image( $gimg_id, 'chillnews_mikado_post_feature_image' );
							} ?>
						</a></li>
					<?php endforeach;
				endif;
