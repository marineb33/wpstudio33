...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="mkdf-post-content">
		...
		<div class="mkdf-post-image-holder">
			...
			<?php chillnews_mikado_get_module_template_part('templates/lists/parts/image', 'blog'); ?>

			<?php chillnews_mikado_post_info_share(array('share' => $display_share)) ?>
		</div>
        <?php }
        else{ ?>
            <?php chillnews_mikado_post_info_category(array('category' => $display_category)) ?>
        ...
        <?php do_action('chillnews_mikado_blog_list_tags'); ?>
