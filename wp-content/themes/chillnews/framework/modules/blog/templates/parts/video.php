...
<?php if($_video_type == "youtube") { ?>
	<iframe  src="http://www.youtube.com/embed/<?php echo esc_attr(get_post_meta(get_the_ID(), "mkdf_post_video_id_meta", true));  ?>?wmode=transparent" wmode="Opaque" width="1100" height="684" allowfullscreen></iframe>
<?php } elseif ($_video_type == "vimeo"){ ?>
	<iframe src="http://player.vimeo.com/video/<?php echo esc_attr(get_post_meta(get_the_ID(), "mkdf_post_video_id_meta", true));  ?>?title=0&amp;byline=0&amp;portrait=0" width="1100" height="684" allowFullScreen></iframe>
		...
		<div class="mkdf-video-wrap">
			<video class="mkdf-self-hosted-video" poster="<?php echo esc_url(get_post_meta(get_the_ID(), "video_format_image", true));  ?>" preload="auto">
				...
				<object width="320" height="240" type="application/x-shockwave-flash" data="<?php echo esc_url(get_template_directory_uri().'/assets/js/flashmediaelement.swf'); ?>">
					...
					<img src="<?php echo esc_url(get_post_meta(get_the_ID(), "mkdf_post_video_image_meta", true));  ?>" width="1920" height="800" title="No video playback capabilities" alt="<?php esc_html_e('Video thumb','chillnews'); ?>" />
				</object>
			</video>
		</div>
	</div>
