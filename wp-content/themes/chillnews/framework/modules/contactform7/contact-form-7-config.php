<?php
if ( ! function_exists('chillnews_mikado_contact_form_map') ) {
	/**
	 * Map Contact Form 7 shortcode
	 * Hooks on vc_after_init action
	 */
	function chillnews_mikado_contact_form_map()
	{
	...
	add_action('vc_after_init', 'chillnews_mikado_contact_form_map');
}
?>