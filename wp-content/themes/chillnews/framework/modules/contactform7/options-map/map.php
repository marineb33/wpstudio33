...
if ( ! function_exists('chillnews_mikado_contact_form_7_options_map') ) {

	function chillnews_mikado_contact_form_7_options_map() {

		chillnews_mikado_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> 'Contact Form 7',
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = chillnews_mikado_add_admin_panel(array(
		...
		$typography_text_group = chillnews_mikado_add_admin_group(array(
		...
		$typography_text_row1 = chillnews_mikado_add_admin_row(array(
		...
		$typography_text_row2 = chillnews_mikado_add_admin_row(array(
		...
		$typography_text_row3 = chillnews_mikado_add_admin_row(array(
		...
		$typography_label_group = chillnews_mikado_add_admin_group(array(
		...
		$typography_label_row1 = chillnews_mikado_add_admin_row(array(
		...
		$typography_label_row2 = chillnews_mikado_add_admin_row(array(
		...
		$background_border_group = chillnews_mikado_add_admin_group(array(
		...
		$background_border_row1 = chillnews_mikado_add_admin_row(array(
		...
		$background_border_row2 = chillnews_mikado_add_admin_row(array(
		...
		$background_border_row3 = chillnews_mikado_add_admin_row(array(
		...
		$padding_group = chillnews_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
		...
		$padding_row = chillnews_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		$margin_group = chillnews_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
		...
		$margin_row = chillnews_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = chillnews_mikado_add_admin_group(array(
		...
		$button_typography_row1 = chillnews_mikado_add_admin_row(array(
		...
		$button_typography_row2 = chillnews_mikado_add_admin_row(array(
		...
		$button_background_border_group = chillnews_mikado_add_admin_group(array(
		...
		$button_background_border_row1 = chillnews_mikado_add_admin_row(array(
		...
		$button_background_border_row2 = chillnews_mikado_add_admin_row(array(
		...
		$button_background_border_row3 = chillnews_mikado_add_admin_row(array(
		...
		$panel_contact_form_style_2 = chillnews_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
	...
	add_action( 'chillnews_mikado_options_map', 'chillnews_mikado_contact_form_7_options_map', 15);
}