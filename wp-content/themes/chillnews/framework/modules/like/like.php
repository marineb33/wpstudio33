...
class ChillNewsLike {
	...
	private function __construct() {
		...
		add_action('wp_ajax_chillnews_mikado_like', array( $this, 'ajax'));
		add_action('wp_ajax_nopriv_chillnews_mikado_like', array( $this, 'ajax'));
	}
	...
	public function add_like() {
		...
		$title = esc_html__('Like this', 'chillnews');
		if( isset($_COOKIE['mkdf-like_'. $post->ID]) ){
			$class = 'mkdf-like liked';
			$title = esc_html__('You already like this!', 'chillnews');
		}
...
global $chillnews_mikado_global_like;
$chillnews_mikado_global_like = ChillNewsLike::get_instance();
