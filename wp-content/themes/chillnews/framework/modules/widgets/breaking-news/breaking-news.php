 ...
 * Class Breaking_News
 */
class ChillNewsBreakingNews extends ChillNewsWidget {
    /**
    ...
    public function widget($args, $instance) {
        ...
        ?>
        <div class="mkdf-bn-holder" <?php echo chillnews_mikado_get_inline_attrs($data); ?>>
            <?php if($queryResult->have_posts()): ?>
                <div class="mkdf-bn-title"><?php esc_html_e('Trending News', 'chillnews'); ?><span class="mkdf-bn-icon ion-arrow-right-b"></span></div>
