...
/**
 * Widget that adds post layout nine
 *
 * Class PostLayoutNine
 */
class ChillNewsPostLayoutnine extends ChillNewsWidget {
    /**
     * Set basic widget options and call parent class construct
     */
    public function __construct() {
        parent::__construct(
            'mkd_post_layout_nine_widget', // Base ID
            'Mikado Post Layout Nine Widget' // Name
        );
    ...
    public function widget($args, $instance) {
        ...
        $instance['thumb_image_width'] = $instance['thumb_image_width'] != '' ? $instance['thumb_image_width'] : '65';
        $instance['thumb_image_height'] = $instance['thumb_image_height'] != '' ? $instance['thumb_image_height'] : '65';
        ...
        echo '<div class="widget mkdf-plw-nine">';

        //finally call the shortcode
        echo do_shortcode("[mkdf_post_layout_nine $params]"); // XSS OK

        echo '</div>'; //close div.mkdf-plw-nine
    }
}