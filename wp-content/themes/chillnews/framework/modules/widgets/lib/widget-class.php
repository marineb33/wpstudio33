 ...
 *
 * Class ChillNewsWidget
 */
abstract class ChillNewsWidget extends WP_Widget {
    /**
    ...
    public function form($instance) {
        if(is_array($this->params) && count($this->params)) {
            ...
            <p><?php esc_html_e('There are no options for this widget.', 'chillnews'); ?></p>
        <?php }
    }
...
$chillnews_mikado_global_Framework = ChillNewsFramework::get_instance();
$mkdSkinManager = new ChillNewsSkinManager();
$chillnews_mikado_global_Framework->setSkin($mkdSkinManager->getSkin());
