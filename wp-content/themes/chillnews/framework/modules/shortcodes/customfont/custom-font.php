<?php
namespace ChillNewsNamespace\Modules\CustomFont;
...
class CustomFont implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Mikado Custom Font', 'chillnews'),
				'base' => $this->getBase(),
				'category' => 'by MIKADO',
				...
				'params' => array(
					...
					array(
						...
						"value" => chillnews_mikado_get_font_style_array(),
                        'save_always'	=> true,
						"description" => ""
					),
					array(
						...
						"value" => chillnews_mikado_get_font_weight_array(),
						"save_always" => true
					),
					array(
						"type" => "textfield",
					...
					array(
						...
						"value" => chillnews_mikado_get_text_transform_array(),
                        'save_always'	=> true,
						"description" => ""
					),
					array(
	...
	public function render($atts, $content = null) {
		...
		$html = chillnews_mikado_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
