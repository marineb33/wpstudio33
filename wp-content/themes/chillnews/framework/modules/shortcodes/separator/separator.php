<?php
namespace ChillNewsNamespace\Modules\Separator;
...
class Separator implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Mikado Separator', 'chillnews'),
				'base' => $this->base,
				'category' => 'by MIKADO',
	...
	public function render($atts, $content = null) {
		...
		$html = chillnews_mikado_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if ($params['width'] !== '') {
			if(chillnews_mikado_string_ends_with($params['width'], '%') || chillnews_mikado_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(chillnews_mikado_string_ends_with($params['top_margin'], '%') || chillnews_mikado_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(chillnews_mikado_string_ends_with($params['bottom_margin'], '%') || chillnews_mikado_string_ends_with($params['bottom_margin'], 'px')) {
