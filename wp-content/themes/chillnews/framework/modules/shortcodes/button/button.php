<?php
namespace ChillNewsNamespace\Modules\Shortcodes\Button;
 ...
 * @package ChillNewsNamespace\Modules\Shortcodes\Button
 */
class Button implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Mikado Button', 'chillnews'),
            'base'                      => $this->base,
            'category'                  => 'by MIKADO',
            'admin_enqueue_css' => array(chillnews_mikado_get_skin_uri().'/assets/css/mkdf-vc-extend.css'),
            ...
            'params'                    => array_merge(
                ...
                chillnews_mikado_icon_collections()->getVCParamsArray(array(), '', true),
                array(
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => 'Color',
                    ...
                    array(
                        ...
                        'value'       => chillnews_mikado_get_font_weight_array(true),
                        'admin_label' => true,
                        'group'       => 'Design Options',
                        'save_always' => true
                    ),
                    array(
                        ...
                        'heading'     => 'Margin',
                        'param_name'  => 'margin',
                        'description' => esc_html__('Insert margin in format: 0px 0px 1px 0px', 'chillnews'),
                        'admin_label' => true,
                        'group'       => 'Design Options'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'admin_label' => true,
                        'dependency'  => array('element' => chillnews_mikado_icon_collections()->iconPackParamName, 'not_empty' => true),
                        'group'       => 'Icon Options'
                    ),
                )
            ) //close array_merge
    ...
    public function render($atts, $content = null) {
        ...
        return chillnews_mikado_get_shortcode_module_template_part('templates/'.$params['html_type'], 'button', $params['hover_animation'], $params);
    }
    ...
    private function getButtonStyles($params) {
        ...
        if(!empty($params['font_size'])) {
            $styles[] = 'font-size: '.chillnews_mikado_filter_px($params['font_size']).'px';
        }
