...
if ( ! function_exists('chillnews_mikado_footer_options_map') ) {
	/**
	 * Add footer options
	 */
	function chillnews_mikado_footer_options_map() {
		...
		$footer_panel = chillnews_mikado_add_admin_panel(
			array(
				'title' => 'Footer',
				'name' => 'footer',
				'page' => '_footer_page'
		...
		$show_footer_top_container = chillnews_mikado_add_admin_container(
			array(
		...
		$show_footer_bottom_container = chillnews_mikado_add_admin_container(
			array(
	...
	add_action( 'chillnews_mikado_options_map', 'chillnews_mikado_footer_options_map', 12);
}