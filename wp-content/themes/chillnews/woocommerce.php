...
get_header();
chillnews_mikado_get_title();
get_template_part('slider');
?>

<div class="mkdf-container" <?php chillnews_mikado_inline_style($background_color); ?>>
	<div class="mkdf-container-inner clearfix" <?php chillnews_mikado_inline_style($content_style); ?>>
		<?php
			//Woocommerce content
			if ( ! is_singular('product') ) {
				...
				switch( $sidebar ) {
						...
						<div class="mkdf-two-columns-66-33 mkdf-content-has-sidebar mkdf-woocommerce-with-sidebar clearfix">
							<div class="mkdf-column1">
								<div class="mkdf-column-inner">
									<?php chillnews_mikado_woocommerce_content(); ?>
								</div>
							</div>
					...
					<?php
						break;
					default:
						chillnews_mikado_woocommerce_content();
				}
