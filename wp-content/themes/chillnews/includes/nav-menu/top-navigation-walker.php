 ...
 */
if (!class_exists('ChillNewsTopNavigationWalker')) {
	class ChillNewsTopNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				$angle_icon   = '';
				if($depth !== 0) {
					$angle_icon = '<i class="mkdf_menu_arrow ion-chevron-right"></i>';
				}
